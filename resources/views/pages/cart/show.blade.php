                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                @php
                                    ...
                                    $instrumentTotal = $cartCollection->sum(function($item) {
                                        return ($item['instrument']['rental_price'] ?? 0) * ($item['quantity'] ?? 0);
                                    });
                                @endphp
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    Instruments
                                    <span>Rs. {{ number_format($instrumentTotal, 2) }}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    Shipping
                                    <span>Free</span>
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    ...
                                    <strong>Rs. {{ number_format($instrumentTotal, 2) }}</strong>
                                </li>
                            </ul>
